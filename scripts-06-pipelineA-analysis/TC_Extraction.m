...
% EXPERIMENT C
% FMRI DATA ANALYSIS - TC EXTRACTION - SPM12
% v0.1
%
% AUTHORS:
...
% RUN THIS ON WINDOWS BECAUSE OF PATHS WRITTEN IN THE SPMs
...
save(fullfile(datasetConfigs.AnalysisPath,'TCs-MT-5mm.mat'),'tcArray','pscArray','nSubjects','nRois','nRuns','delay_tc')
save(fullfile(outputFolder,'TCs-MT-5mm.mat'),'tcArray','pscArray','nSubjects','nRois','nRuns','delay_tc')
