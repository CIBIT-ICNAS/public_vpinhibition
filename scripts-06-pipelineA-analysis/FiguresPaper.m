...
legend(trialLabels([5 4 6]),'fontSize',14, 'Location','southeast')
s2.FontSize = 14;
% ------------------------------------------------------------------------%
...
%% Figure EXTRA - Full TC with fixed adapting condition - PSC
...
for tt = [1 4]
    ...
    shadedErrorBar(xvector,...
        ERA_G.BilateralMT.(trialTestTps{tt}).psc.stats.mean,...
        ERA_G.BilateralMT.(trialTestTps{tt}).psc.stats.sem,...
        'lineprops',{'.-','Color',clrMapSimple(tt,:),'LineWidth',1.5,'MarkerSize',10});
...
text(6,   yy(2)-0.4,'Coherent','HorizontalAlignment','center','FontSize',14)
text(15.5,yy(2)-0.4,'Test','HorizontalAlignment','center','FontSize',14)
text(20,  yy(2)-0.4,'MAE','HorizontalAlignment','center','FontSize',14)
text(23,  yy(2)-0.4,'Report','HorizontalAlignment','center','FontSize',14)

legend(trialLabels([1 4]),'fontSize',14, 'Location','southeast')
s1.FontSize = 14;
% ------------------------------------------------------------------------%
% ------------------------------------------------------------------------%
s2=subplot(3,1,2);
...
text(6,   yy(2)-0.4,'Incoherent','HorizontalAlignment','center','FontSize',14)
text(15.5,yy(2)-0.4,'Test','HorizontalAlignment','center','FontSize',14)
text(20,  yy(2)-0.4,'MAE','HorizontalAlignment','center','FontSize',14)
text(23,  yy(2)-0.4,'Report','HorizontalAlignment','center','FontSize',14)

legend(trialLabels([5 2]),'fontSize',14, 'Location','southeast')
s2.FontSize = 14;
% ------------------------------------------------------------------------%
% ------------------------------------------------------------------------%
s3=subplot(3,1,3);
...
text(6,   yy(2)-0.4,'Non-adapting','HorizontalAlignment','center','FontSize',14)
text(15.5,yy(2)-0.4,'Test','HorizontalAlignment','center','FontSize',14)
text(20,  yy(2)-0.4,'MAE','HorizontalAlignment','center','FontSize',14)
text(23,  yy(2)-0.4,'Report','HorizontalAlignment','center','FontSize',14)

legend(trialLabels([3 6]),'fontSize',14, 'Location','southeast')
s3.FontSize = 14;
% ------------------------------------------------------------------------%

%% Export fig
print(fig3,fullfile(outputFolder,sprintf('FiguresPaper_3_psc.png')),'-dpng')
print(fig3,fullfile(outputFolder,sprintf('FiguresPaper_3_psc.svg')),'-dsvg')
