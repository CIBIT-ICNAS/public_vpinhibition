...
input_keyPath = fullfile('..','data','expA-raw-keypress-output'); % raw keypress data (generated by the stimulus scripts)
output_keyPath = fullfile('..','data','expA-analysis-keypress'); % output folder
