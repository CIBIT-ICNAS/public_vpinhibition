...
input_keyPath = fullfile('..','data','expB-raw-keypress-output'); % raw keypress data (generated by the stimulus scripts)
output_keyPath = fullfile('..','data','expB-analysis-keypress'); % output folder
