function [  ] = drawFixationCross_MRI( window , S , cond , event )
...
if cond == S.reportCondIdx      % Report Condition (Responses) - Orange
...
% elseif any(cond == 5:10) % debugg
%     fixCrossColor = [255 255 0];
