...
D.n_dots_plaid = round(2750 * T.factor);

D.dots_veloc_vert = 5 * T.factor;
D.dots_veloc_horiz = 3 * T.factor;

D.dots_size45 = round(4 * T.factor);
D.plaid_border45 = 0.5 * T.factor;
...
D.dots_size_45 = 4 * T.factor;
D.plaid_border_45 = 0.5 * T.factor;
